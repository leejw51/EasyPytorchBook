...
2. [神经网络回归](#chapter-2)
3. [比特币价格预测](#chapter-3)
4. [为什么激活函数很重要](#chapter-4)
5. [模式分类（简化版MNIST）](#chapter-5)
6. [Softmax与Cross Entropy深度解析](#chapter-6)
7. [Top-K与Temperature采样](#chapter-7)
8. [Token选择：Greedy vs 采样](#chapter-8)
9. [Transformer训练与推理流程](#chapter-9)
...
STEP 3: Training
==================================================
Epoch  20: Loss = 0.4436, Accuracy = 100.0%
Epoch  40: Loss = 0.1710, Accuracy = 100.0%
Epoch  60: Loss = 0.0681, Accuracy = 100.0%
Epoch  80: Loss = 0.0359, Accuracy = 100.0%
Epoch 100: Loss = 0.0228, Accuracy = 100.0%
...
Test Results:
----------------------------------------
  Point (0.6, 0.7): probability = 0.678 → class 1
  Point (0.1, 0.9): probability = 0.016 → class 0
  Point (0.7, 0.8): probability = 0.898 → class 1
...
STEP 3: Training
==================================================
Epoch 100: MSE Loss = 0.8995, MAE = $8.65k
Epoch 200: MSE Loss = 0.6162, MAE = $7.11k
Epoch 300: MSE Loss = 0.3998, MAE = $5.56k
Epoch 400: MSE Loss = 0.2580, MAE = $4.63k
Epoch 500: MSE Loss = 0.1671, MAE = $3.85k
...
Predictions vs Actual (Training Data):
---------------------------------------------
  House 1: Actual $200k, Predicted $198.2k (error: -1.8k)
  House 2: Actual $300k, Predicted $296.9k (error: -3.1k)
  House 3: Actual $400k, Predicted $395.7k (error: -4.3k)
  House 4: Actual $220k, Predicted $224.2k (error: +4.2k)
  House 5: Actual $330k, Predicted $335.9k (error: +5.9k)
...
New House Price Predictions:
---------------------------------------------
  House: 1400 sqft, 3 rooms → Predicted: $284.0k
  House: 2500 sqft, 5 rooms → Predicted: $494.4k
  House: 800 sqft, 1 rooms → Predicted: $138.4k
...
STEP 3: Training
=======================================================
Epoch 100: MSE Loss = 1.9534, MAE = $1.32k
Epoch 200: MSE Loss = 1.9209, MAE = $1.29k
Epoch 300: MSE Loss = 1.9209, MAE = $1.29k
Epoch 400: MSE Loss = 1.9209, MAE = $1.29k
Epoch 500: MSE Loss = 1.9209, MAE = $1.29k
...
-------------------------------------------------------
  ...
  Day 4: Actual $30k, Predicted $30.4k (error: +0.4k)
  Day 5: Actual $55k, Predicted $56.4k (error: +1.4k)
...
-------------------------------------------------------
  Medium volume, Neutral sentiment
    ...
    → Predicted BTC: $36.9k ($36941)

  Very high volume, Extremely bullish
    Volume: $60B, Sentiment: +0.9
    → Predicted BTC: $75.6k ($75578)

  Very low volume, Very bearish
    Volume: $15B, Sentiment: -0.8
    → Predicted BTC: $17.0k ($16974)

  Medium-high volume, Moderately bullish
    Volume: $40B, Sentiment: +0.3
    → Predicted BTC: $49.8k ($49820)
...
## 第6章：Softmax与Cross Entropy深度解析
### Softmax & Cross Entropy Deep Dive

*Softmax和Cross Entropy损失的逐步可视化*
...
Results from 10 samples: {'dog': 3, 'cat': 7}
...
## 第9章：Transformer训练与推理流程
### Transformer Training & Inference Flow

*类Transformer模型的整体训练和生成流程*
...
| 任务 | 输出激活 | 损失函数 | 优化器 |
|------|---------|---------|--------|
| 二分类 | Sigmoid | BCELoss | SGD/Adam |
| 多类别分类 | Softmax | CrossEntropyLoss | Adam |
| 回归 | 无（线性） | MSELoss | Adam |
...
with torch.no_grad():                # 禁用梯度
    ...
    prediction = output.argmax()     # 获取类别（分类）
```
