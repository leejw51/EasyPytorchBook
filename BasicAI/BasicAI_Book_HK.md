...
2. [神經網絡回歸](#chapter-2)
3. [比特幣價格預測](#chapter-3)
4. [點解激活函數咁重要](#chapter-4)
5. [模式分類（簡化版MNIST）](#chapter-5)
6. [Softmax同Cross Entropy深入解析](#chapter-6)
7. [Top-K同Temperature採樣](#chapter-7)
8. [Token選擇：Greedy vs 採樣](#chapter-8)
9. [Transformer訓練同推論流程](#chapter-9)
...
STEP 3: Training
==================================================
Epoch  20: Loss = 0.6456, Accuracy = 60.0%
Epoch  40: Loss = 0.4898, Accuracy = 60.0%
Epoch  60: Loss = 0.2635, Accuracy = 100.0%
Epoch  80: Loss = 0.1370, Accuracy = 100.0%
Epoch 100: Loss = 0.0844, Accuracy = 100.0%
...
Test Results:
----------------------------------------
  Point (0.6, 0.7): probability = 0.494 → class 0
  Point (0.1, 0.9): probability = 0.041 → class 0
  Point (0.7, 0.8): probability = 0.725 → class 1
...
STEP 3: Training
==================================================
Epoch 100: MSE Loss = 432.8194, MAE = $194.74k
Epoch 200: MSE Loss = 199.7500, MAE = $120.89k
Epoch 300: MSE Loss = 99.9970, MAE = $77.62k
Epoch 400: MSE Loss = 65.4720, MAE = $70.89k
Epoch 500: MSE Loss = 56.0182, MAE = $67.11k
...
Predictions vs Actual (Training Data):
---------------------------------------------
  House 1: Actual $200k, Predicted $274.6k (error: +74.6k)
  House 2: Actual $300k, Predicted $274.6k (error: -25.4k)
  House 3: Actual $400k, Predicted $274.6k (error: -125.4k)
  House 4: Actual $220k, Predicted $274.6k (error: +54.6k)
  House 5: Actual $330k, Predicted $274.6k (error: -55.4k)
...
New House Price Predictions:
---------------------------------------------
  House: 1400 sqft, 3 rooms → Predicted: $274.6k
  House: 2500 sqft, 5 rooms → Predicted: $274.6k
  House: 800 sqft, 1 rooms → Predicted: $274.6k
...
STEP 3: Training
=======================================================
Epoch 100: MSE Loss = 1.9535, MAE = $1.31k
Epoch 200: MSE Loss = 1.9216, MAE = $1.30k
Epoch 300: MSE Loss = 1.9216, MAE = $1.30k
Epoch 400: MSE Loss = 1.9216, MAE = $1.30k
Epoch 500: MSE Loss = 1.9215, MAE = $1.30k
...
-------------------------------------------------------
  Medium volume, Neutral sentiment
    ...
    → Predicted BTC: $37.0k ($36991)

  Very high volume, Extremely bullish
    Volume: $60B, Sentiment: +0.9
    → Predicted BTC: $75.3k ($75275)

  Very low volume, Very bearish
    Volume: $15B, Sentiment: -0.8
    → Predicted BTC: $16.8k ($16832)

  Medium-high volume, Moderately bullish
    Volume: $40B, Sentiment: +0.3
    → Predicted BTC: $49.8k ($49752)
...
## 第6章：Softmax同Cross Entropy深入解析
### Softmax & Cross Entropy Deep Dive

*Softmax同Cross Entropy損失嘅逐步可視化*
...
## 第9章：Transformer訓練同推論流程
### Transformer Training & Inference Flow

*類Transformer模型嘅整體訓練同生成流程*
...
| 任務 | 輸出激活 | 損失函數 | 優化器 |
|------|---------|---------|--------|
| 二元分類 | Sigmoid | BCELoss | SGD/Adam |
| 多類別分類 | Softmax | CrossEntropyLoss | Adam |
| 回歸 | 冇（線性） | MSELoss | Adam |

### 訓練循環模式

```python
for epoch in range(epochs):
    predictions = model(X)           # 前向傳播
    loss = criterion(predictions, y) # 計算損失
...
with torch.no_grad():                # 禁用梯度
    ...
    prediction = output.argmax()     # 獲取類別（分類）
```
